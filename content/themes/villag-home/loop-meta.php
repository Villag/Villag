...
?>
	...
	<?php elseif ( is_search() ) : ?>
		...
		<div class="loop-meta">
			...
			<div class="loop-description">
				<p>
				<?php printf( __( 'You are browsing the search results for &quot;%1$s&quot;', 'villag_home' ), esc_attr( get_search_query() ) ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_date() ) : ?>
		...
		<div class="loop-meta">
			<h1 class="loop-title"><?php _e( 'Archives by date', 'villag_home' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives by date.', 'villag_home' ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_archive() ) : ?>
		...
		<div class="loop-meta">
			...
			<h1 class="loop-title"><?php _e( 'Archives', 'villag_home' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives.', 'villag_home' ); ?>
				</p>
			</div><!-- .loop-description -->
