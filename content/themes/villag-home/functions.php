 ...
 * @copyright Copyright (c) 2013, Villag
 */
...
add_action( 'after_setup_theme', 'villag_home_theme_setup' );
 ...
 * @since 0.1.0
 */
function villag_home_theme_setup() {
	...
	add_action( 'wp_enqueue_scripts', 'villag_home_enqueue_scripts' );

	/* Embed width/height defaults. */
	add_filter( 'embed_defaults', 'villag_home_embed_defaults' );
	
	/* Reconfigure some WordPress settings to work with Bootstrap. */
	add_action( 'init', 'villag_home_bootstrap_setup' );

	/* Filter the sidebar widgets. */
	add_filter( 'sidebars_widgets', 'villag_home_disable_sidebars' );
	add_action( 'template_redirect', 'villag_home_one_column' );
 ...
 * @since 0.1.0
 */
function villag_home_enqueue_scripts() {
 ...
 * @since 0.1.0
 */
function villag_home_one_column() {

	if ( !is_active_sidebar( 'primary' ) && !is_active_sidebar( 'secondary' ) )
		add_filter( 'get_theme_layout', 'villag_home_theme_layout_one_column' );
 ...
 * @since 0.2.0
 */
function villag_home_theme_layout_one_column( $layout ) {
	return 'layout-1c';
}

function villag_home_get_layout( $id = '' ) {
 ...
 * @since 0.1.0
 */
function villag_home_disable_sidebars( $sidebars_widgets ) {
	global $wp_query;
 ...
 * @since 0.1.0
 */
function villag_home_embed_defaults( $args ) {
...
function villag_home_bootstrap_setup(){
